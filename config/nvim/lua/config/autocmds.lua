...
--
-- Both environments now run Solarized Dark, so the dim shade is solarized's
-- base02 (#073642) everywhere — one muted step up from the base03 (#002b36)
-- background, so the unfocused pane reads as a lighter overlay rather than
-- blending in.
